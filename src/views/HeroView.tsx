            ...
            <section id="home" className={`p-4 sm:p-6 md:p-8 lg:p-10`}>
                ...
                <article className="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p className={`${styles.paragraph} max-w-[470px] mt-5 animate-fade-right animate-duration-[2000ms]`}>
                    ...
                    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
                        <img src={`/public/images/hero_image.svg`} alt="billing" className="block animate-fade-left animate-duration-[2000ms]" />
